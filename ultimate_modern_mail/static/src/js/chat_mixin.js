odoo.define('mail.chat_mixin', function () {
    ...
    var ChatMixin = {
        ...
        }, _deleteMessage: function (message_id) {
            this.trigger_up('delete_message', {
                message_id: message_id,
            });
        },
    };
...
odoo.define('mail.chat_service', function (require) {
    ...
    web_client.on('delete_message', web_client, function (event) {
        event.data.callback(chat_manager.delete_message(event.data.message_id));
    });
