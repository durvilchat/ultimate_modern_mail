odoo.define('mail.chat_client_action', function (require) {
    ...
    var ChatAction = Widget.extend(ControlPanelMixin, {
        ...
        _renderThread: function () {
            ...
            this.thread = new ChatThread(null, {display_help: true});
            ...
            this.thread.on('unselect_message_edit', this, this._unselectMessageEdit);
        ...
        _startListening: function () {
            ...
            chat_manager.bus.on('delete_message_up', this, this._onMessageDelete);
         ...
         * @param {string} type the channel type
         */
        _onMessageDelete: function (message) {
            var self = this;
            this._fetchAndRenderThread();
            this._updateChannels();
        },
